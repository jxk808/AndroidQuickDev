...
package com.base.framework.toast
...
import com.base.framework.databinding.WidgetTipsToastBinding
...
object TipsToast {
    ...
    fun showTips(msg: SpannableStringBuilder) {
        showTipsImpl(
            msg,
            Toast.LENGTH_SHORT
        )
